...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_agency_limits'])) {
    ...
    if ($conn->query("UPDATE users SET client_limit = $client_limit WHERE id = $agency_id")) {
        $message = "Agency client limit updated successfully!";
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                if ($agencies_result->num_rows > 0): 
                                    ...
                                    <tr onclick="openAgencyEditModal(<?php echo $row['id']; ?>, '<?php echo addslashes($row['username']); ?>', <?php echo $row['client_limit']; ?>)">
