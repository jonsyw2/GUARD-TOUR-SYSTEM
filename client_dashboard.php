...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .nav-link:hover, .nav-link.active { background-color: #1f2937; color: #fff; border-left-color: #3b82f6; } /* Blue for Client */
    ...
    <main class="main-content">
        ...
        <div class="content-area">
            <div class="card">
                ...
                <p style="color: #6b7280; font-size: 1rem; line-height: 1.5;">Welcome to your client dashboard! Here you can monitor tour reports and manage your account settings.</p>
            </div>
        </div>
    </main>
