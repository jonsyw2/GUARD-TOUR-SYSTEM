...
// Get all agency_client mapping IDs for this agency
$maps_sql = "SELECT id FROM agency_clients WHERE agency_id = $agency_id";
...
// Fetch filter options: Inspectors (belonging to this agency)
...
$history_sql = "
    ...
    JOIN users cu ON ac.client_id = cu.id
...
<head>
    ...
    <title>Inspector Visit History - Agency Portal</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        /* Modal Styles */
        .modal-overlay { display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(17, 24, 39, 0.7); z-index: 2000; backdrop-filter: blur(4px); overflow-y: auto; padding: 20px; }
        .modal-overlay.show { display: flex; align-items: flex-start; justify-content: center; }
        .modal-content { background: white; padding: 32px; border-radius: 12px; width: 100%; max-width: 450px; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1); position: relative; margin: auto; animation: modalFadeIn 0.3s ease-out forwards; }
        ...
        /* Photo View Styles */
        .btn-view-photo { padding: 6px 12px; background-color: #10b981; color: white; border: none; border-radius: 6px; font-size: 0.75rem; font-weight: 600; cursor: pointer; transition: all 0.2s; }
        .btn-view-photo:hover { background-color: #059669; }
                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="7" class="empty-state">No inspector visits found for the selected criteria.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
